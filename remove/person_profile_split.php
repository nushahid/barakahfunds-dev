    ...
    <div class="person-profile-main-v5">
        <div class="card person-hero-card-v5">
            ...
            <div class="person-actions-v5">
                ...
                <a class="btn" href="expense_page_split.php?person_id=<?= (int)$person['ID'] ?>">Add Expense</a>
                <a class="btn" href="direct_support_page.php?person_id=<?= (int)$person['ID'] ?>">Add Direct Support</a>
